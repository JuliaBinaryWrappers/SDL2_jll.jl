# Autogenerated wrapper script for SDL2_jll for armv6l-linux-musleabihf
export libsdl2
...
function __init__()
    JLLWrappers.@generate_init_header(Xorg_libX11_jll, Xorg_libXcursor_jll, Xorg_libXext_jll, Xorg_libXinerama_jll, Xorg_libXrandr_jll, Xorg_libXScrnSaver_jll, Libglvnd_jll, alsa_jll, alsa_plugins_jll)
